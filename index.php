...
if(!empty($_POST)) {
  ...
  if(empty($date) or empty($time) or empty($contactNum) or empty($address) or empty($postcode) or empty($state) or empty($name)) {
  ...
  (date, time, contactNum, address, postcode, state, accountID)
  VALUES
  ('$date', '$time', '$contactNum', '$address', '$postcode', '$state', '$name')
  ";
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="inputBox">
              ...
              <input type="item" placeholder="Bread/Noodle/Rice......" />
            </div>
            ...
            <div class="delivery">
              ...
              <input
                type="radio"
                name="delivery"
                value="Send it yourself"
              />Send it yourself
              <input type="radio" name="delivery" value="Our pick up" />Our pick
              up
            </div>
            ...
            <div class="inputBox">
              <span>City :</span>
              <input type="text" placeholder="Cheras" />
            </div>
